...
## 🎯 PROJE HAKKINDA
**Stok Kontrol Sistemi**, küçük ve orta ölçekli işletmelerin depo ürünlerini, müşteri kayıtlarını ve satış işlemlerini dijitalleştirmek için tasarlanmış bir **ASP.NET Core Razor Pages** web uygulamasıdır. 
...
## ✨ DETAYLI ÖZELLİKLER
Sistem, işletme akışını kolaylaştıran temel modüllerden oluşur:
...
<br>
<p align="center">
  <i>Eğitim ve geliştirme amacıyla tasarlanmıştır. Katkıda bulunmak için Pull Request gönderebilirsiniz!</i> 🌟
</p>
